...
export default function SWdev() {
  return (
    <>
      ...
      <SWdevcards />
      <DtsInfo header="Our Approach" desc="We transform your vision into adaptable software, using agile practices and expert teams. This ensures fast delivery, scalability, and continuous innovation for your business." img={img1} img2={img}/>
      <SWdevinfo />
