...
export default function Integration() {
    return (
        <>
            ...
            <IntegrationInfo />
            <DtsInfo img2={img2} header="Our Approach to Integration" desc="We take a holistic approach to deliver tailored integration solutions. Here's how we ensure a successful project:" img={img1} />
            <IntegrationInfo3 />
